...
public class Vector4 : global::System.IDisposable {
  ...
  public void Dot(Vector4 vVector, SWIGTYPE_p_float o_nDot) {
    RockPINVOKE.Vector4_Dot__SWIG_1(swigCPtr, Vector4.getCPtr(vVector), SWIGTYPE_p_float.getCPtr(o_nDot));
    if (RockPINVOKE.SWIGPendingException.Pending) throw RockPINVOKE.SWIGPendingException.Retrieve();
  }
